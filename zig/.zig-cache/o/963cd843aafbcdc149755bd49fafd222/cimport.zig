...
pub extern fn window_contract(time_a: [*c]const i32, a: [*c]const i32, na: c_int, time_b: [*c]const i32, b: [*c]const i32, nb: c_int, window: i32, threshold: i32, nresult: [*c]i32) void;
pub extern fn recency_dot(a: [*c]const i32, time_a: [*c]const i32, b: [*c]const i32, time_b: [*c]const i32, n: c_int, result: [*c]i64) void;
pub extern fn window_gradient(arr: [*c]const i32, n: c_int, window: i32, result: [*c]i32) void;
